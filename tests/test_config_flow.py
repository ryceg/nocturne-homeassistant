...
from custom_components.nocturne.const import CONF_INSTANCE_URL
...
class TestAsyncOAuthCreateEntry:
    async def test_persists_instance_url(self):
        flow = NocturneOAuth2FlowHandler()
        flow.hass = MagicMock()
        ...
        assert create_call.kwargs["data"][CONF_INSTANCE_URL] == "https://example.com"
